...
<template>
    <div>
        <div class="min-h-screen flex flex-col pt-6 sm:pt-0 bg-gray-100 relative bg-dots-darker bg-center dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white ">
            <nav class="bg-gray">
